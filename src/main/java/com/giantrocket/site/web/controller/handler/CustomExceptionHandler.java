...
public class CustomExceptionHandler {
	...
	public static final String INTERNAL_SERVER_ERROR_MSG = "Bueno... tenemos un inconveniente con uno de nuestros servicios (o todos, quien sabe), pero lo m�s probable es que nuestros desarrolladores ya lo esten viendo, calma";
