...
<html>
	<head>
	    ...
	    <title>Inscripción de Equipos</title>
	...
	<body class="home">
		    	...
		    	<div class="row">
		    		...
		    		<div class="col-sm-3 text-left">
						...
						<div class='form-group'>
							...
							<input class="mustComplete form-control" type="text" id="mail" name="mail" value="" placeholder="contact@evilgeniuses.com">
		...
		<div class="container-fluid">
	    		...
	    		<div class="row">
		    		...
		    		<div class="col-sm-6 text-center">
					  <div class="checkbox form-group">
					    <label>
					      <input type="checkbox" class="rules"> <span> Acepto los terminos y condiciones del </span><br> <a target="_blank" href="/rules">Reglamento de Torneos de Giant Rocket</a>
					    </label>
					  </div>
		    		</div>
		    		<div class="col-sm-3 text-left"></div>
	    	...
	    	<div class="container-fluid">
	    		<div class="row">
				   	<div class="col-sm-3 text-left"></div>
		    		<div class="col-sm-6 last-section">
		    			<input type="submit" id="create-team" class="btn btn-primary create-button col-xs-2 col-xs-offset-5 text-center" value="Inscribir">
		    		</div>
		    		<div class="col-sm-3 text-left"></div>
				</div>
			</div>
		...
		$(document).ready(function() {
			var playerNumber = 0;
				while(playerNumber < 7){
					...
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='name'>Nombre*</label><br> <input placeholder='Clinton' class='tagEditor mustComplete form-control' type='text' id ='name' name='name' value=''></div>";
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='idNumber'>Documento*</label><br> <input type='text' placeholder='34383757' class='mustComplete form-control' id='idNumber' name='idNumber' value=''></div>";
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='nick'>Nick*</label><br> <input class='mustComplete form-control' placeholder='Fear' type='text' id='nick' name='nick' value=''></div>";
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='dotabuff'>Dotabuff Url</label><br> <input class='form-control' placeholder='http://dotabuff.com/players/86890833' type='text' id='dotabuff' name='dotabuff' value=''></div>";
					...
					htmlComplete += "<div class='form-group relativeLocation'> <label class='team-labels relativeLocation' for='city'>Ciudad*</label><br class='relativeLocation'> <input placeholder='Ciudad Autonoma de Buenos Aires' class='mustComplete form-control relativeLocation' type='text' id='city' name='city' value=''> </div>"
					...
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='lastName'>Apellido*</label><br> <input placeholder='Loomis' class='tagEditor mustComplete form-control' type='text' id='lastName' name='lastName' value=''></div>";
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='birthday'>Fecha de nacimiento*</label><br> <input readonly='readonly' placeholder='18/12/1991' style='background:white;cursor:pointer;'class='birthday mustComplete form-control' type='text' id='birthday"+playerNumber+"'></div>";
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='pictureUrl'>Foto de perfil*</label><br> <input placeholder='imgur.com/8flyD2F.jpg' class='mustComplete form-control' type='text' id='pictureUrl' name='pictureUrl' value=''></div>";
					htmlComplete += "<div class='form-group'> <label class='team-labels' for='steam'>Steam Url*</label><br> <input class='mustComplete form-control' placeholder='http://steamcommunity.com/profiles/76561198047156561' type='text' id='steam' name='steam' value=''></div>";
					...
					htmlComplete += "<div class='form-group relativeLocation'> <label class='team-labels relativeLocation' for='neighbourhood'>Barrio*</label><br class='relativeLocation' > <input placeholder='Caballito' class='mustComplete relativeLocation form-control' type='text' id='neighbourhood' name='neighbourhood' value=''> </div>";
					htmlComplete += "</div>";
